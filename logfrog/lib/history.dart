...
class History {
  String _historyID; //History ID (autogenerated)
  ...
  History(this._historyID, this._itemID, this._itemName, this._memID, this._memName, this._timeCheckedOut, this._timeCheckedIn);
  ...
  static Map<String, dynamic> toMap(History history) {
    ...
    if (history._historyID != "") { //if the string is not empty for item being checked out
      map['historyID'] = history._historyID;
    }
    map['historyID'] = history._historyID;
