    ...
    if (_validateAndSave()) {
      ...
      try {
        if (_formMode == FormMode.LOGIN) {
          userId = await widget.auth.signIn(widget.email, _password);
          print('Signed in: $userId');
        } else {
          userId = await widget.auth.signUp(widget.email, _password);
    ...
    return new Hero(
      ...
      child: Padding(
        ...
        child: CircleAvatar(
          ...
          radius: 100,
          child: Image.asset('assets/FrogLog_Clear.png',),
        ),
      ),
    );
  }
